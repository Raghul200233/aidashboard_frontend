...
| **20+ Question Types** | Count, List, Total, Average, Top/Bottom, Distribution, Trend, Compare, Filter, Multi-Condition, OR Logic, Record Lookup, Compare Records, Profit Margin, Correlation, Forecast, Text Search, Time Intelligence |
...
| **Hugging Face** | AI/NLP for intent parsing |
